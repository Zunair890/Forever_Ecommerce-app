      ...
      <div>
        {
          cartData.map((item,index)=>{
            ...
            return(
              <div key={index} className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_2fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-3">
      ...
      <div className="flex justify-end my-20">
         <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button onClick={()=>navigate("/place-order")} className="bg-black  active:bg-gray-8  00 text-white text-sm my-8 px-8 py-3">PROCEED TO CHECKOUT</button>
          </div>
