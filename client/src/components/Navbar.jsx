     ...
     <img src={assets.logo} className="w-36" alt="" /></Link>
       ...
       <div className="flex items-center gap-6">
        ...
        <div className="group relative">
         <img onClick={()=>navigate("/login")} src={assets.profile_icon} className="w-5 cursor-pointer" />
        ...
        <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-sqaure rounded-full text-[9px] ">{getCartCount()}</p>
        </Link>
