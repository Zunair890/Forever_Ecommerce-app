...
function Login({setToken}) {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center w-full'>
     <div className='bg-white shadow-md rounded-lg px-8 py-9 max-w-md'>
        ...
        <button className='text-white bg-black mt-2 w-full py-2 px-4 rounded-md' type='submit'>Login</button>
        </form>
     </div>
    </div>
  )
